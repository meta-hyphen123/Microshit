...
class main:
  def install_tools(self):
    while True:
      ...
      print(f"")
      logo.back()
      cmd=input(f"{blue}Microshit{nc}@{blue}space {yellow}$ {nc}")
        ...
        try:
          if int(cmd) in range(1,int(total)+1):
            while True:
              ...
              print(f"")
              logo.back()
              tcmd=input(f"{blue}Microshit{nc}@{blue}space {yellow}$ {nc}")
    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Microshit"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/meta-hyphen123/Microshit.git "+system.home+"/Microshit")
            if os.path.exists(system.home+"/Microshit/install.aex"):
              os.system("cd "+system.home+"/Microshit && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Microshit"):
              ...
              os.system("git clone https://github.com/meta-hyphen123/Microshit.git "+system.home+"/Microshit")
            if os.path.exists(system.home+"/Microshit/install.aex"):
              os.system("cd "+system.home+"/Microshit && sh install.aex")
              if os.path.exists(system.bin+"/Microshit") and os.path.exists(system.conf_dir+"/Microshit"):
                os.system("clear")
                logo.updated()
                cmd=input(f"{blue}Microshit{nc}@{blue}space {yellow}$ {nc}")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Microshit")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Microshit")
        else:
          os.system("rm -rf "+system.bin+"/Microshit")
          os.system("rm -rf "+system.conf_dir+"/Microshit")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Microshit/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Microshit/core/cat.json") as cat_file:
